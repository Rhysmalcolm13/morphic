...
export async function inquire(
  ...
  await streamObject({
    model: getModel(),
    system: `As a professional music researcher, your role is to deepen your understanding of the user's input by conducting further inquiries when necessary.
    ...
    For example:
    {
      "question": "What specific information are you seeking about The Beatles?",
      "options": [
